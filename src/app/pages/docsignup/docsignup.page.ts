...
import { AuthentService } from '../../apis/authent.service';

@Component({
  selector: 'app-docsignup',
  templateUrl: './docsignup.page.html',
  styleUrls: ['./docsignup.page.scss'],
})
export class DocsignupPage implements OnInit {
  ...
  constructor(private router:Router, public authentService:AuthentService) { 
  ...
  sign_up(email, password){
    this.authentService.RegisterUser(email.value, password.value)
    .then((res) => {
      // Do something here
      this.authentService.SendVerificationMail()
